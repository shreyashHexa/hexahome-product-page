...
const FaqPage = ({ faqs }) => {
    ...
    return (
        <div className={`gap-8 px-16 py-8 ${isScrolled ? 'bg-white text-black' : 'bg-white text-black'}`}>
            <div className="text-base text-center">
                <h2 className="inline-block px-4 py-2 text-lg font-semibold bg-gradient-to-r from-[#D8E3FF] to-white rounded-full md:text-xl text-tblue">Frequently Asked Questions</h2>
